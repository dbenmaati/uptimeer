	...
	<div class="h-full w-full pt-4 sm:pt-16">
		...
		<section class="flex items-center h-full sm:p-16 dark:bg-gray-50 dark:text-gray-800">
			<div class="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
				...
				<p class="text-1xl">Oh nooo, You are lost</p>
				<p class="text-3xl">404 Not Found</p>
				<a rel="noopener noreferrer" href="/login" class="px-8 py-3 font-semibold rounded dark:bg-violet-600 dark:text-gray-50">Back to homepage</a>
			</div>
		</section>
